      ...
      <div className="container-custom">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-heading)] text-3xl md:text-4xl lg:text-5xl font-bold text-secondary-dark mb-4">
            Your Roadmap to Food{' '}
            <span className="gradient-text-primary">Business Success</span>
          </h2>
          <p className="text-lg text-muted leading-relaxed">
            Follow our proven 5-step framework that has helped hundreds of
            entrepreneurs launch successful food businesses in India.
          </p>
        </motion.div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative mb-6">
                      <div className="w-24 h-24 rounded-full bg-white border-2 border-primary/20 flex items-center justify-center shadow-md group-hover:shadow-xl group-hover:border-primary/50 transition-all duration-300 relative z-10">
                    ...
                    {/* Content */}
                    <h3 className="font-[family-name:var(--font-heading)] text-lg font-bold text-secondary-dark mb-2 group-hover:text-primary transition-colors">
                      {step.title}
                    </h3>
                    ...
                    >
                      ...
                      <div className="absolute -left-8 sm:-left-12 flex-shrink-0">
                        <div className="relative">
                          <div className="w-[30px] h-[30px] sm:w-[46px] sm:h-[46px] rounded-full bg-white border-2 border-primary/30 flex items-center justify-center shadow-md group-hover:border-primary transition-all">
                      ...
                      {/* Content */}
                      <div className="bg-surface rounded-xl p-5 sm:p-6 flex-1 border border-border-light group-hover:shadow-md transition-shadow">
                        <h3 className="font-[family-name:var(--font-heading)] text-lg font-bold text-secondary-dark mb-1.5 group-hover:text-primary transition-colors">
                          {step.title}
                        </h3>
